 ...
 * 	0.0.6.20140926<br>
 */
public class JavaKitStringUtil {
    ...
    public static List<String> tuoFeng(String s){
        ...
        if(JavaKitStringUtil.notEmpty(s)){
    ...
    public static String getClassNameFromTableName(String tableName){
        StringBuilder sb = new StringBuilder();
        if(JavaKitStringUtil.notEmpty(tableName)){
            String[] ss = tableName.split("_");
            for(int i=1; i<ss.length; i++){
                sb.append(JavaKitStringUtil.firstUpper(ss[i].toLowerCase()));
            }
        }
    ...
    public static String getTableNameFromClazzName(String clazzName){
        ...
        List<String> names = JavaKitStringUtil.tuoFeng(clazzName);
        for(String s: names){
